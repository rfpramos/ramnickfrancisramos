...
const labs = [
  ...
  },
  {
    ...
    description:
      'Placed 8th of the entire participants of the Capture the Flag Competition; a collection of explainer on a three-day-long Capture the Flag Competition that encompasses skills on Forensics, Web Security, Cryptography, Binary Exploitation, etc.',
  ...
  },
  {
    ...
    description:
      'A laboratory report made to explore the privilege escalation attained on adding a malicious script or payload to environemnt variables in a vulerability-simulated Ubuntu 20.04 Virtual Machine.',
  ...
  },
  {
    ...
    description:
      'A comprehensive laboratory report that explores how digital environments employ asymmetric encryption for public key infrasturctures for a more secure communication between entities.',
  ...
  },
  {
    name: 'SQL Injection',
    description:
      'A detailed laboratory report that shows how the SQL Database of a simulated web-based database management system for payroll could be tampered through SQL injections.',
  ...
  },
  {
    ...
    description:
      'An in-depth laboratory report that exhibits how injection attacks of malicious script may be be made to a certain networking web application ',
 ...
 * 
        <section id="projects">
          <div className="projects">
            ...
            <ProjectCard
              title="Tulong Los Baños"
              description="Worked on designing the user experience and developing the user interface of a Flutter Mobile
Application while working on the Firebase Integration to serve as a donation management system for Los Baños, Laguna"
              image="assets/images/tulong.jpg"
            />

            <ProjectCard
              title="Elbi Food Review"
              description="Developed a database management system for a Food Review Application in Los Baños, Laguna using
MariaDB and Python"
...
const projects = [
  ...
  // if there are no projects, Projects section won't show up
  {
    ...
    description:[
        'Worked on the development of a web-based database management system that aims to streamline the data curation process of nucleotide sequences, incoporating several bioinformatics tools using different Node Packages',
        'Developed in colaboration with the Center for Caves Research of the University of the Philippines Los Baños\' Museum of Natural History',
  ...
  {
    name: 'Tulong Los Baños',
    type: 'Mobile Application',
    description:
      'Worked as a lead on the UI/UX Designing and frontend development of a database management system for donation drives in Los Baños, Laguna.',
  ...
  },
  {
    ...
    description:
      'Ranked 1st in the Laboratory Section for the culminating activity; implemented experimental research design in making a companion mobile application for the annual protest music festival UPLB February Fair using Figma.',
...
UPLB Computational Interdisciplinary Research Labs (CINTERLABS) Los Baños, Laguna
...
const experiences = [
  {
    ...
    details:[
      'Collaborated with a team of six developers in making MERN-stacked web development projects in making dashboard for microbial research datasets.',
      'Managed 120+ biological profilings data made by microbiology researchers from the Museum of Natural History of the University of the Philippines Los Baños.']
  },
  {
    ...
    details:[
       'Utilized Jira for reporting bugs and collaborating with developers on improving a live-streaming application. ',
       'Conducted smoke testing sprints as an intern following Agile Methodology Principles. '
